...
surface_post "admin auth pre-auth-session" "${SANDWICH_ADMIN_BASE_URL}" "/api/auth/session/pre-auth-session" "" "" "200" "400"
...
surface_skip "admin auth sms login" "未实现功能不纳入 API surface 冒烟"
surface_skip "admin auth wecom login" "当前环境未配置企业微信登录"
surface_skip "admin auth github login" "当前环境未配置 GitHub 登录"
surface_post "admin auth logout" "${SANDWICH_ADMIN_BASE_URL}" "/api/auth/session/logout" "{}" "" "400"
surface_post "admin auth token verify" "${SANDWICH_ADMIN_BASE_URL}" "/api/auth/session/token/verify" "{}" "" "200" "400"
surface_post "admin auth oauth2 introspect" "${SANDWICH_ADMIN_BASE_URL}" "/api/auth/session/oauth2/introspect" "{}" "" "200" "400"
surface_post "admin auth oauth2 userinfo" "${SANDWICH_ADMIN_BASE_URL}" "/api/auth/session/oauth2/userinfo" "{}" "" "200" "400"
...
surface_post "admin current user info update" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/current-user/info/update" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin current user password update" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/current-user/password/update" "{}" "${admin_token}" "200" "400" "401" "403"
surface_multipart_post "admin current user avatar upload" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/current-user/avatar/upload" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin sys user get" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/get" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin sys user create" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/create" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys user update" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/update" "{}" "${admin_token}" "200" "400" "401" "403"
surface_multipart_post "admin sys user avatar upload" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/avatar/upload" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys user avatar delete" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/avatar/delete" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys user avatar post" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/avatar" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys user enable" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/enable" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys user delete" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/user/delete" "{}" "${admin_token}" "200" "400" "401" "403"
...
for resource in role menu dict department; do
    ...
    surface_post "admin sys ${resource} get" "${SANDWICH_ADMIN_BASE_URL}" "${base_path}/get" "{}" "${admin_token}" "200" "400" "401" "403"
    surface_post "admin sys ${resource} list" "${SANDWICH_ADMIN_BASE_URL}" "${base_path}/list" "{}" "${admin_token}" "200" "400" "401" "403"
    surface_post "admin sys ${resource} create" "${SANDWICH_ADMIN_BASE_URL}" "${base_path}/create" "{}" "${admin_token}" "200" "400" "401" "403"
    surface_post "admin sys ${resource} update" "${SANDWICH_ADMIN_BASE_URL}" "${base_path}/update" "{}" "${admin_token}" "200" "400" "401" "403"
    surface_post "admin sys ${resource} delete" "${SANDWICH_ADMIN_BASE_URL}" "${base_path}/delete" "{}" "${admin_token}" "200" "400" "401" "403"
done

surface_post "admin sys role enable" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/role/enable" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys role sort" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/role/sort" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin sys role user assign" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/role/user/assign" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys menu display" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/menu/display" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys menu tree" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/menu/tree" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys menu move" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/menu/move" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin sys dict sort" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/dict/sort" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys department tree" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/department/tree" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin sys department move" "${SANDWICH_ADMIN_BASE_URL}" "/api/sys/department/move" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_multipart_post "admin storage object upload" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/object/upload" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin storage object delete" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/object/delete" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin storage object sort" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/object/sort" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin storage object tree" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/object/tree" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin storage multipart create" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/multipart-upload" "{}" "${admin_token}" "200" "400" "401" "403"
surface_multipart_post "admin storage multipart part" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/multipart-upload/0/parts" "${admin_token}" "200" "400" "401" "403" "404"
surface_post "admin storage multipart complete" "${SANDWICH_ADMIN_BASE_URL}" "/api/storage/multipart-upload/0/complete" "{}" "${admin_token}" "200" "400" "401" "403" "404"
...
surface_post "admin submission create" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/create" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin submission get" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/get" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin submission change status" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/change-status" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin submission delete" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/delete" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin submission sort" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/sort" "{}" "${admin_token}" "200" "400" "401" "403"
surface_multipart_post "admin submission image upload" "${SANDWICH_ADMIN_BASE_URL}" "/api/submission/submission/image/upload" "${admin_token}" "200" "400" "401" "403"

surface_post "admin open client create" "${SANDWICH_ADMIN_BASE_URL}" "/api/open/client/create" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin open client update" "${SANDWICH_ADMIN_BASE_URL}" "/api/open/client/update" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin open client get" "${SANDWICH_ADMIN_BASE_URL}" "/api/open/client/get" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin open client change status" "${SANDWICH_ADMIN_BASE_URL}" "/api/open/client/change-status" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin open client secret reset" "${SANDWICH_ADMIN_BASE_URL}" "/api/open/client/secret/reset" "{}" "${admin_token}" "200" "400" "401" "403"

surface_post "admin audit meta" "${SANDWICH_ADMIN_BASE_URL}" "/api/audit/log/meta" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin audit history" "${SANDWICH_ADMIN_BASE_URL}" "/api/audit/log/history" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin audit detail" "${SANDWICH_ADMIN_BASE_URL}" "/api/audit/log/detail" "{}" "${admin_token}" "200" "400" "401" "403"
surface_post "admin audit object overview" "${SANDWICH_ADMIN_BASE_URL}" "/api/audit/log/object/overview" "{}" "${admin_token}" "200" "400" "401" "403"
...
surface_post "admin audit fields" "${SANDWICH_ADMIN_BASE_URL}" "/api/audit/log/fields" "{}" "${admin_token}" "200" "400" "401" "403"

smoke_log "probing front api surface"
surface_post "front auth pre-auth-session" "${SANDWICH_FRONT_BASE_URL}" "/api/auth/session/pre-auth-session" "" "" "200" "400"
...
surface_post "front auth logout" "${SANDWICH_FRONT_BASE_URL}" "/api/auth/session/logout" "{}" "" "200" "400"
