...
INSERT INTO `sys_menu` (
    ...
    (
        1000000000000001029, NULL, 57, 62, '审计管理', NULL, 0,
        'VISIBLE', '{"icon":"audit"}', '/audit', NULL, '审计管理根菜单'
    ),
    (
        1000000000000001030, 1000000000000001029, 58, 61, '审计日志', NULL, 0,
        'VISIBLE', '{"icon":"audit-logs"}', '/audit/logs', NULL, '审计日志'
    ),
    (
        1000000000000001031, 1000000000000001030, 59, 60, '审计查看', 'audit:view', 0,
        'HIDDEN', '{"icon":"permission"}', NULL, NULL, '审计查看权限'
    )
ON DUPLICATE KEY UPDATE
    `parent_id` = VALUES(`parent_id`),
    `lft` = VALUES(`lft`),
...
INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES
    ...
    (1000000000000000401, 1000000000000001029),
    (1000000000000000401, 1000000000000001030),
    (1000000000000000401, 1000000000000001031),
    ...
    (1000000000000000402, 1000000000000001029),
    (1000000000000000402, 1000000000000001030),
    (1000000000000000402, 1000000000000001031),
    ...
    (1000000000000000405, 1000000000000001029),
    (1000000000000000405, 1000000000000001030),
    (1000000000000000405, 1000000000000001031),
...
INSERT INTO `sys_dict` (
    ...
    (
        1000000000000002110, 'user_rank', '等级 0', '0', 0, '用户访问等级 0'
    ),
    (
        1000000000000002111, 'user_rank', '等级 1', '1', 1, '用户访问等级 1'
    ),
    (
        1000000000000002112, 'user_rank', '等级 2', '2', 2, '用户访问等级 2'
    ),
    (
        1000000000000002113, 'user_rank', '等级 3', '3', 3, '用户访问等级 3'
    ),
    (
        1000000000000002114, 'user_rank', '等级 4', '4', 4, '用户访问等级 4'
    ),
    (
        1000000000000002115, 'user_rank', '等级 5', '5', 5, '用户访问等级 5'
    ),
    (
        1000000000000002116, 'user_rank', '等级 6', '6', 6, '用户访问等级 6'
    ),
    (
        1000000000000002117, 'user_rank', '等级 7', '7', 7, '用户访问等级 7'
    ),
    (
        1000000000000002118, 'user_rank', '等级 8', '8', 8, '用户访问等级 8'
    ),
    (
        1000000000000002119, 'user_rank', '超级管理员', '9', 9, '用户访问等级 9'
    ),
    (
