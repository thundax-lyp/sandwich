...
public class XssShieldUtil {
        ...
        ret.add(
                new Object[] {
                    "\\s*\\w*\\s*("
                            ...
                            + "onerroupdate|onfilterchange|onfinish|onfocus|onfocusin|"
                            ...
                            + "onmousemove|onmousout|onmouseover|onmouseup|onmousewheel|onmove|"
                            + "onmoveend|onmovestart|onabort|onactivate|onafterprint|"
                            + "onafterupdate|onbefore|onbeforeactivate|onbeforecopy|onbeforecut|"
                            + "onbeforedeactivate|onbeforeeditocus|onbeforepaste|onbeforeprint|"
                            + "onbeforeunload|onbeforeupdate|onblur|onbounce|oncellchange|"
                            + "onchange|onclick|oncontextmenu|onpaste|onpropertychange|"
                            + "onreadystatechange|onreset|onresize|onresizend|onresizestart|"
    ...
    public static void main(String[] args) {
        ...
        String value = null;
        value =
                XssShieldUtil.stripXss(
                        "<script language=text/javascript>alert(document.cookie);</script>");
