...
INSERT INTO `sys_menu` (
    ...
    (
        'menu-user', 'menu-system', 2, 7, '用户管理', NULL, 0,
        'VISIBLE', NULL, '/system/users', NULL, 1, '用户管理',
        '2026-05-05 00:00:00.000', 'system', NULL, NULL, '0'
    ),
    (
        'menu-user-view', 'menu-user', 3, 4, '用户查看', 'sys:user:view', 0,
        'HIDDEN', NULL, NULL, NULL, 1, '用户查看权限',
        '2026-05-05 00:00:00.000', 'system', NULL, NULL, '0'
    ),
    (
        'menu-user-edit', 'menu-user', 5, 6, '用户编辑', 'sys:user:edit', 0,
    ...
    (
        'menu-role-view', 'menu-role', 9, 10, '角色查看', 'sys:role:view', 0,
        'HIDDEN', NULL, NULL, NULL, 1, '角色查看权限',
        '2026-05-05 00:00:00.000', 'system', NULL, NULL, '0'
    ),
    (
        'menu-role-edit', 'menu-role', 11, 12, '角色编辑', 'sys:role:edit', 0,
...
INSERT INTO `sys_role_menu` (`role_id`, `menu_id`) VALUES
    ...
    ('role-super-admin', 'menu-user-view'),
    ('role-super-admin', 'menu-user-edit'),
    ...
    ('role-super-admin', 'menu-department-edit'),
    ('role-super-admin', 'menu-dict'),
    ('role-super-admin', 'menu-dict-view'),
    ('role-super-admin', 'menu-dict-edit'),
    ('role-super-admin', 'menu-log'),
    ('role-super-admin', 'menu-storage'),
    ('role-super-admin', 'menu-storage-object'),
    ('role-super-admin', 'menu-storage-object-view'),
    ('role-super-admin', 'menu-storage-object-edit'),
    ('role-super-admin', 'menu-assist'),
    ('role-super-admin', 'menu-assist-signature-view'),
    ('role-super-admin', 'menu-assist-signature-edit')
ON DUPLICATE KEY UPDATE
