...
public class JetCacheAutoConfigurationTest {
    ...
    public void shouldCustomizeGlobalCacheConfigWithProjectDefaults() {
        BeanPostProcessor beanPostProcessor =
                JetCacheAutoConfiguration.jetCacheGlobalConfigBeanPostProcessor();
        ...
        assertArrayEquals(
                new String[] {JetCacheAutoConfiguration.BASE_PACKAGE},
        ...
        assertEquals(
                JetCacheAutoConfiguration.DEFAULT_STAT_INTERVAL_MINUTES,
                globalCacheConfig.getStatIntervalMinutes());
    }
