package com.github.thundax.common.web.configure;
...
public class SandwishWebConfigurationTest {

    private final WebApplicationContextRunner contextRunner =
            new WebApplicationContextRunner().withConfiguration(AutoConfigurations.of(SandwishWebConfiguration.class));
